  ...
  constructor() {
    ...
    <header>
      <div id="header-left">
        ...
        <a class="fancy-link" href="/play/" id="play-link">
          <div id="link-with-icon-div">
          Play&nbsp;
      ...
      <div id="header-right">
        <a class="fancy-link" href="/leaderboard/">
          <div id="link-with-icon-div">
          Leaderboard&nbsp;
        ...
        <a class="fancy-link" href="/practice/">
          <div id="link-with-icon-div">
            Practice&nbsp;
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6" width="24" height="24">
        ...
        <a class="fancy-link" href="/profile/">
